...
const ACStarRatingsBlog = () => {
  return (
    <Layout>
      <div className="container mx-auto pt-8 px-4 sm:px-6 lg:px-20 select-text">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4">
          ...
          <li>
            <span className="font-semibold">3-star AC:</span> Moderate energy
            efficiency; ideal for infrequent use or smaller budgets.
          </li>
          <li>
            <span className="font-semibold">5-star AC:</span> High energy
            efficiency; excellent for frequent use and long-term savings.
          </li>
        </ul>
        ...
        <p className="text-gray-700 leading-relaxed mt-4">
          ...
          to over <span className="font-semibold">₹3,360 annually</span>.
        </p>
